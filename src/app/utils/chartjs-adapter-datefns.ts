...
_adapters._date.override({
    ...
    parse: function (value: any, fmt: string) {
    ...
    format: function (time: number, fmt: string | ((n: Date) => string)) {
        switch (typeof fmt) {
            case 'string': return format(time, fmt, this.options);
            case 'function': return fmt(new Date(time));
    ...
    startOf: function (time: number, unit: string, weekday: number) {
        switch (unit) {
